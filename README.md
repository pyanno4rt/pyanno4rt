...
<ul>
	...
	<li> <b>Multi-objective treatment plan optimization</b>
		<br>
		<ul>
			<li> Dose-volume and outcome prediction model-based optimization functions
				<ul>
	...
	<li> <b>Data-driven outcome prediction model handling</b>
		...
		<ul> 
			...
			<li> 3 highly customizable internal model classes for logistic regression, neural network and support vector machine
				<ul> 
...
<ul>
	...
	<li> jaxlib (>=0.4.25) </li>
	<li> numba (>=0.59.0) </li>
	<li> python-levenshtein (>=0.25.0) </li>
