...
from pyanno4rt.gui.compilations.components.lkb_ntcp_window import (
    Ui_lkb_ntcp_window)
from pyanno4rt.gui.custom_widgets import CheckableComboBox
from pyanno4rt.optimization.components import LymanKutcherBurmanNTCP
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class LKBNTCPWindow(QMainWindow, Ui_lkb_ntcp_window):
    """
    LKB NTCP component window for the GUI.

    This class sets up the LKB NTCP component window for the graphical user \
    interface, including input fields for parameterization.
    ...
    def __init__(
        ...
        self.set_zero_line_cursor((
            'td50_ledit', 'slope_ledit', 'vol_eff_ledit', 'weight_ledit',
    ...
    def connect_signals(self):
        ...
        for key, value in {
                'td50_ledit': self.update_save_button,
                'slope_ledit': self.update_save_button,
    ...
    def load(
        ...
        (segment, td50, slope_parameter, volume_parameter, component_type,
        embedding, weight, rank, bounds, link, identifier, display) = (
        ...
        for key, value in {
                'td50_ledit': str(td50),
                'slope_ledit': str(slope_parameter),
    ...
    def save(self):
        ...
        # Get the component
        component = LymanKutcherBurmanNTCP(
            segment=self.segment_cbox.currentText(),
            tolerance_dose_50=string_to_numeric(self.td50_ledit.text()),
            slope_parameter=string_to_numeric(self.slope_ledit.text()),
    ...
    def update_save_button(self):
        ...
        self.save_pbutton.setEnabled(
            all(text != '' for text in (
                    ...
                    self.td50_ledit.text(),
                    self.slope_ledit.text(),
