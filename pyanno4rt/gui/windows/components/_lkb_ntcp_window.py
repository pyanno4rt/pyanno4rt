...
class LKBNTCPWindow(QMainWindow, Ui_lkb_ntcp_window):
    ...
    def load(
        ...
        td50 = component[segment]['instance']['parameters'][
            'tolerance_dose_50']
        slope = component[segment]['instance']['parameters']['slope_parameter']
        vol_eff = component[segment]['instance']['parameters'][
            'volume_parameter']
        ...
        for key, value in {
                'td50_ledit': str(float(td50)),
                'slope_ledit': str(float(slope)),
                'vol_eff_ledit': str(float(vol_eff)),
    ...
    def save(self):
        ...
        component_string = ' - '.join((substring for substring in (
            self.segment_cbox.currentText(), 'Lyman-Kutcher-Burman NTCP',
