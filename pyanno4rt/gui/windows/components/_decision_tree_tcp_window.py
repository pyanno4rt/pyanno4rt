"""Decision tree TCP component window."""
...
from pyanno4rt.gui.compilations.components.decision_tree_tcp_window import (
    Ui_decision_tree_tcp_window)
...
class DecisionTreeTCPWindow(QMainWindow, Ui_decision_tree_tcp_window):
    """
    Decision tree TCP component window for the GUI.

    This class sets up the decision tree TCP component window for the \
    ...
    def close(self):
        """Close the decision tree TCP window."""
