...
class DecisionTreeTCPWindow(
        QMainWindow, Ui_decision_tree_tcp_window):
    """
    Decision tree TCP component window for the application.

    This class creates a decision tree TCP component window for the \
