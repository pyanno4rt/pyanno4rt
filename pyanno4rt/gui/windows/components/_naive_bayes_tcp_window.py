...
from pyanno4rt.optimization.components import NaiveBayesTCP
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class NaiveBayesTCPWindow(QMainWindow, Ui_naive_bayes_tcp_window):
    """
    Naive Bayes TCP component window for the GUI.

    This class sets up the naive Bayes TCP component window for the \
    ...
    def close(self):
        """Close the naive Bayes TCP window."""
