...
class SquaredUnderdosingWindow(QMainWindow, Ui_squared_underdosing_window):
    ...
    This class creates a squared underdosing component window for the \
    ...
    def load(self, component):
        ...
        minimum_dose = component[key]['instance']['parameters']['minimum_dose']
        ...
        # 
        self.min_dose_ledit.setText(str(float(minimum_dose)))
