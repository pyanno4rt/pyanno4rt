"""Squared underdosing component window."""
...
from pyanno4rt.gui.compilations.components.squared_underdosing_window import (
    Ui_squared_underdosing_window)
...
class SquaredUnderdosingWindow(QMainWindow, Ui_squared_underdosing_window):
    """
    Squared underdosing component window for the GUI.

    This class sets up the squared underdosing component window for the \
    ...
    def __init__(
        ...
        self.set_zero_line_cursor((
            'min_dose_ledit', 'weight_ledit', 'lower_bound_ledit',
    ...
    def connect_signals(self):
        ...
        for key, value in {
                'min_dose_ledit': self.update_save_button,
                }.items():
    ...
    def close(self):
        """Close the squared underdosing window."""
