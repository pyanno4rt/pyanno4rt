"""Dose uniformity component window."""
...
from pyanno4rt.gui.compilations.components.dose_uniformity_window import (
    Ui_dose_uniformity_window)
...
from pyanno4rt.optimization.components import DoseUniformity
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class DoseUniformityWindow(QMainWindow, Ui_dose_uniformity_window):
    """
    Dose uniformity component window for the GUI.

    This class sets up the dose uniformity component window for the graphical \
    ...
    def __init__(
        ...
        # Set a fixed size
        self.segment_link_cbox.setFixedSize(431, 31)
    ...
    def load(
        ...
        (segment, component_type, embedding, weight, rank, bounds, link,
         identifier, display) = component.arguments.values()
    ...
    def update_save_button(self):
        ...
        self.save_pbutton.setEnabled(self.segment_cbox.currentText() != '')
    ...
    def close(self):
        """Close the dose uniformity window."""
