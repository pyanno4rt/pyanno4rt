...
from pyanno4rt.gui.compilations.components.mean_dose_window import (
    Ui_mean_dose_window)
...
from pyanno4rt.optimization.components import MeanDose
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class MeanDoseWindow(QMainWindow, Ui_mean_dose_window):
    """
    Mean dose component window for the GUI.

    This class sets up the mean dose component window for the graphical user \
