...
class EquivalentUniformDoseWindow(
    ...
    This class creates an equivalent uniform dose component window for the \
    ...
    def __init__(
        ...
        self.target_eud_ledit.textChanged.connect(self.update_save_button)
    ...
    def load(self, component):
        ...
        target_eud = component[key]['instance']['parameters']['target_eud']
        ...
        # 
        self.target_eud_ledit.setText(str(float(target_eud)))
    ...
    def update_save_button(self):
        ...
        if any(text == '' for text in (
                self.segment_cbox.currentText(), self.target_eud_ledit.text(),
