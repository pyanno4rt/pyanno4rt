...
class KNeighborsTCPWindow(
        QMainWindow, Ui_k_nearest_neighbors_tcp_window):
    """
    ...
    def load(
        ...
        for key, value in {
                ...
                'p_ledit': (
                    '' if not tune_space.get('p')
                    or tune_space['p'] == [1, 2, 3]
    ...
    def save(self):
        ...
        component = {
            self.segment_cbox.currentText(): {
                ...
                'instance': {
                    'function': 'K-Nearest Neighbors TCP',
                    'parameters': {
        ...
        component_string = ' - '.join((substring for substring in (
            self.segment_cbox.currentText(), 'K-Nearest Neighbors TCP',
