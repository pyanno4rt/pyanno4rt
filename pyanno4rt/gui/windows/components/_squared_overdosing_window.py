...
from pyanno4rt.gui.compilations.components.squared_overdosing_window import (
    Ui_squared_overdosing_window)
from pyanno4rt.gui.custom_widgets import CheckableComboBox
from pyanno4rt.optimization.components import SquaredOverdosing
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class SquaredOverdosingWindow(QMainWindow, Ui_squared_overdosing_window):
    """
    Squared overdosing component window for the GUI.

    This class sets up the squared overdosing component window for the \
    ...
    def __init__(
        ...
        self.set_zero_line_cursor((
            'max_dose_ledit', 'weight_ledit', 'lower_bound_ledit',
            'upper_bound_ledit', 'identifier_ledit'))
    ...
    def connect_signals(self):
        ...
        for key, value in {
                'max_dose_ledit': self.update_save_button,
                }.items():
    ...
    def load(
        ...
        (segment, maximum_dose, component_type, embedding, weight, rank,
        ...
        for key, value in {
                'max_dose_ledit': str(maximum_dose),
    ...
    def save(self):
        ...
        # Get the component
        component = SquaredOverdosing(
            segment=self.segment_cbox.currentText(),
            maximum_dose=string_to_numeric(self.max_dose_ledit.text()),
    ...
    def close(self):
        """Close the squared overdosing window."""
