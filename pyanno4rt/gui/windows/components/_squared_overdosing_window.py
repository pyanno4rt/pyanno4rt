...
class SquaredOverdosingWindow(QMainWindow, Ui_squared_overdosing_window):
    ...
    This class creates a squared overdosing component window for the \
    ...
    def __init__(
        ...
        self.max_dose_ledit.textChanged.connect(self.update_save_button)
    ...
    def load(self, component):
        ...
        maximum_dose = component[key]['instance']['parameters']['maximum_dose']
        ...
        # 
        self.max_dose_ledit.setText(str(float(maximum_dose)))
    ...
    def update_save_button(self):
        ...
        if any(text == '' for text in (
                self.segment_cbox.currentText(), self.max_dose_ledit.text())):
