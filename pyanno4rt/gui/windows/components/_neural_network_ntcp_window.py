...
from pyanno4rt.optimization.components import NeuralNetworkNTCP
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class NeuralNetworkNTCPWindow(QMainWindow, Ui_neural_network_ntcp_window):
    """
    Neural network NTCP component window for the GUI.

    This class sets up the neural network NTCP component window for the \
    ...
    def close(self):
        """Close the neural network NTCP window."""
