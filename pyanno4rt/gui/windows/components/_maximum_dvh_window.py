...
from pyanno4rt.optimization.components import MaximumDVH
...
class MaximumDVHWindow(QMainWindow, Ui_maximum_dvh_window):
    """
    Maximum DVH component window for the GUI.

    This class sets up the maximum DVH component window for the graphical \
    ...
    def load(
        ...
        (segment, target_dose, quantile_volume, component_type, embedding,
        ...
        for key, value in {
                ...
                'volume_ledit': str(quantile_volume),
