...
from pyanno4rt.optimization.components import NaiveBayesOutcome
from pyanno4rt.tools import string_to_numeric

# %% Class definition


class NaiveBayesNTCPWindow(QMainWindow, Ui_naive_bayes_ntcp_window):
    """
    Naive Bayes NTCP component window for the GUI.

    This class sets up the naive Bayes NTCP component window for the \
    ...
    def __init__(
        ...
        self.priors_cbox = CheckableComboBox()
        ...
        for box in (
                ...
                'segment_link_cbox', 'rank_sbox', 'priors_cbox',
    ...
    def close(self):
        """Close the naive Bayes NTCP window."""
