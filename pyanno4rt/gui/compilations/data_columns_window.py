...
"border-color: rgb(186, 189, 182);")
        ...
        self.features_table = QtWidgets.QTableWidget(self.data_columns_widget)
        self.features_table.setGeometry(QtCore.QRect(10, 50, 901, 411))
        self.features_table.setMinimumSize(QtCore.QSize(901, 0))
        self.features_table.setMaximumSize(QtCore.QSize(901, 16777215))
        self.features_table.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.features_table.setAlternatingRowColors(True)
        self.features_table.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.features_table.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.features_table.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.features_table.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.features_table.setObjectName("features_table")
        self.features_table.setColumnCount(0)
        self.features_table.setRowCount(0)
        self.features_table.horizontalHeader().setMinimumSectionSize(0)
        self.features_table.verticalHeader().setDefaultSectionSize(25)
        self.features_table.verticalHeader().setMinimumSectionSize(25)
        self.features_label = QtWidgets.QLabel(self.data_columns_widget)
        self.features_label.setGeometry(QtCore.QRect(10, 10, 111, 25))
        font = QtGui.QFont()
        ...
        self.features_plus_tbutton = QtWidgets.QToolButton(self.data_columns_widget)
        self.features_plus_tbutton.setGeometry(QtCore.QRect(10, 470, 31, 31))
        self.features_plus_tbutton.setMinimumSize(QtCore.QSize(31, 31))
        self.features_plus_tbutton.setMaximumSize(QtCore.QSize(31, 31))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.features_plus_tbutton.setIcon(icon)
        self.features_plus_tbutton.setIconSize(QtCore.QSize(18, 18))
        self.features_plus_tbutton.setObjectName("features_plus_tbutton")
        self.features_minus_tbutton = QtWidgets.QToolButton(self.data_columns_widget)
        self.features_minus_tbutton.setGeometry(QtCore.QRect(50, 470, 31, 31))
        self.features_minus_tbutton.setMinimumSize(QtCore.QSize(31, 31))
        self.features_minus_tbutton.setMaximumSize(QtCore.QSize(31, 31))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.features_minus_tbutton.setIcon(icon1)
...
"border-color: rgb(186, 189, 182);")
    ...
    def retranslateUi(self, data_columns_window):
        ...
        self.features_label.setText(_translate("data_columns_window", "Features"))
        self.label_label.setText(_translate("data_columns_window", "Label"))
        self.features_plus_tbutton.setToolTip(_translate("data_columns_window", "Add a component"))
        self.features_minus_tbutton.setToolTip(_translate("data_columns_window", "Remove the selected component"))
