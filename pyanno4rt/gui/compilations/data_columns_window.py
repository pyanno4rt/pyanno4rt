...
"border-color: rgb(186, 189, 182);")
        ...
        self.feature_table.setGeometry(QtCore.QRect(10, 100, 901, 361))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.feature_label.setGeometry(QtCore.QRect(10, 60, 111, 25))
        font = QtGui.QFont()
...
"border-color: rgb(186, 189, 182);")
        ...
        self.preset_save_tbutton = QtWidgets.QToolButton(self.data_columns_widget)
        self.preset_save_tbutton.setGeometry(QtCore.QRect(50, 10, 31, 31))
        self.preset_save_tbutton.setMinimumSize(QtCore.QSize(31, 31))
        self.preset_save_tbutton.setMaximumSize(QtCore.QSize(31, 31))
        self.preset_save_tbutton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.preset_save_tbutton.setStyleSheet("background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/black_icons/icons_black/save.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.preset_save_tbutton.setIcon(icon2)
        self.preset_save_tbutton.setIconSize(QtCore.QSize(18, 18))
        self.preset_save_tbutton.setObjectName("preset_save_tbutton")
        self.preset_load_tbutton = QtWidgets.QToolButton(self.data_columns_widget)
        self.preset_load_tbutton.setGeometry(QtCore.QRect(10, 10, 31, 31))
        self.preset_load_tbutton.setMinimumSize(QtCore.QSize(31, 31))
        self.preset_load_tbutton.setMaximumSize(QtCore.QSize(31, 31))
        self.preset_load_tbutton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.preset_load_tbutton.setStyleSheet("background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/black_icons/icons_black/upload.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.preset_load_tbutton.setIcon(icon3)
        self.preset_load_tbutton.setIconSize(QtCore.QSize(18, 18))
        self.preset_load_tbutton.setObjectName("preset_load_tbutton")
    ...
    def retranslateUi(self, data_columns_window):
        ...
        self.feature_plus_tbutton.setToolTip(_translate("data_columns_window", "Add a feature"))
        self.feature_minus_tbutton.setToolTip(_translate("data_columns_window", "Remove the selected feature"))
        ...
        self.preset_save_tbutton.setToolTip(_translate("data_columns_window", "Save a preset"))
        self.preset_load_tbutton.setToolTip(_translate("data_columns_window", "Load a preset"))
