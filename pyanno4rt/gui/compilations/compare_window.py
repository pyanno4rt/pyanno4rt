...
class Ui_compare_window(object):
    def setupUi(self, compare_window):
        ...
        compare_window.resize(1190, 460)
        compare_window.setMinimumSize(QtCore.QSize(1190, 460))
        compare_window.setMaximumSize(QtCore.QSize(1190, 460))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.close_info_pbutton.setGeometry(QtCore.QRect(1110, 410, 71, 30))
...
"border-color: rgb(211, 215, 207);")
        ...
        self.slice_selection_sbar.setGeometry(QtCore.QRect(130, 410, 971, 30))
...
"margin-right: 6px;")
        ...
        self.difference_widget = QtWidgets.QWidget(self.compare_widget)
        self.difference_widget.setGeometry(QtCore.QRect(800, 30, 390, 346))
        self.difference_widget.setStyleSheet("border: 1px solid;\n"
"border-color: rgb(211, 215, 207);")
        self.difference_widget.setObjectName("difference_widget")
        self.baseline_meta_layout_2 = QtWidgets.QVBoxLayout(self.difference_widget)
        ...
        self.difference_layout = QtWidgets.QVBoxLayout()
        self.difference_layout.setSpacing(3)
        self.difference_layout.setObjectName("difference_layout")
        self.baseline_meta_layout_2.addLayout(self.difference_layout)
        self.difference_label = QtWidgets.QLabel(self.compare_widget)
        self.difference_label.setGeometry(QtCore.QRect(810, 10, 371, 25))
