...
"border-color: rgb(186, 189, 182);")
        ...
        self.link_label.setGeometry(QtCore.QRect(0, 210, 431, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 250, 431, 31))
    ...
    def retranslateUi(self, dose_uniformity_window):
        ...
        self.close_pbutton.setText(_translate("dose_uniformity_window", "Close"))
        ...
        self.save_pbutton.setText(_translate("dose_uniformity_window", "Save"))
