...
# Form implementation generated from reading ui file 'minimum_dvh_window.ui'
#
...
class Ui_minimum_dvh_window(object):
    def setupUi(self, minimum_dvh_window):
        minimum_dvh_window.setObjectName("minimum_dvh_window")
        minimum_dvh_window.setWindowModality(QtCore.Qt.ApplicationModal)
        minimum_dvh_window.resize(720, 431)
        minimum_dvh_window.setMinimumSize(QtCore.QSize(720, 431))
        minimum_dvh_window.setMaximumSize(QtCore.QSize(720, 431))
        minimum_dvh_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(minimum_dvh_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.target_dose_ledit.setGeometry(QtCore.QRect(0, 250, 121, 30))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.volume_ledit.setGeometry(QtCore.QRect(140, 250, 121, 30))
...
"border-color: rgb(186, 189, 182);")
        ...
        minimum_dvh_window.setCentralWidget(self.body_widget)

        self.retranslateUi(minimum_dvh_window)
        self.embedding_cbox.setCurrentIndex(0)
        self.type_cbox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(minimum_dvh_window)

    def retranslateUi(self, minimum_dvh_window):
        _translate = QtCore.QCoreApplication.translate
        minimum_dvh_window.setWindowTitle(_translate("minimum_dvh_window", "Minimum DVH Editor"))
        self.embedding_cbox.setItemText(0, _translate("minimum_dvh_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("minimum_dvh_window", "passive"))
        self.segment_label.setText(_translate("minimum_dvh_window", "Segment"))
        self.embedding_label.setText(_translate("minimum_dvh_window", "Embedding"))
        self.base_label.setText(_translate("minimum_dvh_window", "Base"))
        self.type_cbox.setItemText(0, _translate("minimum_dvh_window", "objective"))
        self.type_cbox.setItemText(1, _translate("minimum_dvh_window", "constraint"))
        self.type_label.setText(_translate("minimum_dvh_window", "Type"))
        self.close_pbutton.setText(_translate("minimum_dvh_window", "Close"))
        self.target_dose_label.setText(_translate("minimum_dvh_window", "Target dose [Gy]"))
        self.identifier_ledit.setPlaceholderText(_translate("minimum_dvh_window", "None"))
        self.identifier_label.setText(_translate("minimum_dvh_window", "Identifier"))
        self.link_label.setText(_translate("minimum_dvh_window", "Link"))
        self.function_label.setText(_translate("minimum_dvh_window", "Function"))
        self.bounds_label.setText(_translate("minimum_dvh_window", "Bounds"))
        self.handling_viz_label.setText(_translate("minimum_dvh_window", "Handling & Visualization"))
        self.weight_label.setText(_translate("minimum_dvh_window", "Weight"))
        self.save_pbutton.setText(_translate("minimum_dvh_window", "Save"))
        self.conjunction.setText(_translate("minimum_dvh_window", "-"))
        self.optimization_label.setText(_translate("minimum_dvh_window", "Optimization"))
        self.rank_label.setText(_translate("minimum_dvh_window", "Rank"))
        self.upper_bound_ledit.setPlaceholderText(_translate("minimum_dvh_window", "+∞"))
        self.weight_ledit.setPlaceholderText(_translate("minimum_dvh_window", "1.0"))
        self.disp_component_check.setText(_translate("minimum_dvh_window", "Display component"))
        self.lower_bound_ledit.setPlaceholderText(_translate("minimum_dvh_window", "-∞"))
