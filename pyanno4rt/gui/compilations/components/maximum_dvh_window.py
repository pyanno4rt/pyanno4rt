...
# Form implementation generated from reading ui file 'maximum_dvh_window.ui'
#
...
class Ui_maximum_dvh_window(object):
    def setupUi(self, maximum_dvh_window):
        maximum_dvh_window.setObjectName("maximum_dvh_window")
        maximum_dvh_window.setWindowModality(QtCore.Qt.ApplicationModal)
        maximum_dvh_window.resize(720, 431)
        maximum_dvh_window.setMinimumSize(QtCore.QSize(720, 431))
        maximum_dvh_window.setMaximumSize(QtCore.QSize(720, 431))
        maximum_dvh_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(maximum_dvh_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.scroll_contents.setGeometry(QtCore.QRect(0, -56, 690, 681))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.target_dose_label.setGeometry(QtCore.QRect(0, 210, 131, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.target_dose_label.setFont(font)
        self.target_dose_label.setStyleSheet("border: 0px solid;")
        self.target_dose_label.setObjectName("target_dose_label")
...
"border-color: rgb(186, 189, 182);")
        ...
        self.target_dose_ledit = QtWidgets.QLineEdit(self.scroll_contents)
        self.target_dose_ledit.setGeometry(QtCore.QRect(0, 250, 131, 31))
        self.target_dose_ledit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.target_dose_ledit.setAlignment(QtCore.Qt.AlignCenter)
        self.target_dose_ledit.setObjectName("target_dose_ledit")
...
"border-color: rgb(186, 189, 182);")
        ...
        self.volume_ledit = QtWidgets.QLineEdit(self.scroll_contents)
        self.volume_ledit.setGeometry(QtCore.QRect(150, 250, 123, 31))
        self.volume_ledit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.volume_ledit.setAlignment(QtCore.Qt.AlignCenter)
        self.volume_ledit.setObjectName("volume_ledit")
        self.volume_label = QtWidgets.QLabel(self.scroll_contents)
        self.volume_label.setGeometry(QtCore.QRect(150, 210, 123, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.volume_label.setFont(font)
        self.volume_label.setStyleSheet("border: 0px solid;")
        self.volume_label.setObjectName("volume_label")
        self.scroll_area.setWidget(self.scroll_contents)
        maximum_dvh_window.setCentralWidget(self.body_widget)

        self.retranslateUi(maximum_dvh_window)
        self.embedding_cbox.setCurrentIndex(0)
        self.type_cbox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(maximum_dvh_window)

    def retranslateUi(self, maximum_dvh_window):
        _translate = QtCore.QCoreApplication.translate
        maximum_dvh_window.setWindowTitle(_translate("maximum_dvh_window", "Maximum DVH Editor"))
        self.embedding_cbox.setItemText(0, _translate("maximum_dvh_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("maximum_dvh_window", "passive"))
        self.segment_label.setText(_translate("maximum_dvh_window", "Segment"))
        self.embedding_label.setText(_translate("maximum_dvh_window", "Embedding"))
        self.base_label.setText(_translate("maximum_dvh_window", "Base"))
        self.type_cbox.setItemText(0, _translate("maximum_dvh_window", "objective"))
        self.type_cbox.setItemText(1, _translate("maximum_dvh_window", "constraint"))
        self.type_label.setText(_translate("maximum_dvh_window", "Type"))
        self.close_component_pbutton.setText(_translate("maximum_dvh_window", "Close"))
        self.target_dose_label.setText(_translate("maximum_dvh_window", "Target dose [Gy]"))
        self.identifier_ledit.setPlaceholderText(_translate("maximum_dvh_window", "None"))
        self.identifier_label.setText(_translate("maximum_dvh_window", "Identifier"))
        self.link_ledit.setPlaceholderText(_translate("maximum_dvh_window", "None"))
        self.link_label.setText(_translate("maximum_dvh_window", "Link"))
        self.function_label.setText(_translate("maximum_dvh_window", "Function"))
        self.bounds_label.setText(_translate("maximum_dvh_window", "Bounds"))
        self.handling_viz_label.setText(_translate("maximum_dvh_window", "Handling & Visualization"))
        self.weight_label.setText(_translate("maximum_dvh_window", "Weight"))
        self.save_component_pbutton.setText(_translate("maximum_dvh_window", "Save"))
        self.conjunction.setText(_translate("maximum_dvh_window", "-"))
        self.optimization_label.setText(_translate("maximum_dvh_window", "Optimization"))
        self.rank_label.setText(_translate("maximum_dvh_window", "Rank"))
        self.upper_bound_ledit.setPlaceholderText(_translate("maximum_dvh_window", "None"))
        self.weight_ledit.setPlaceholderText(_translate("maximum_dvh_window", "1.0"))
        self.disp_component_check.setText(_translate("maximum_dvh_window", "Display component"))
        self.lower_bound_ledit.setPlaceholderText(_translate("maximum_dvh_window", "0.0"))
        self.volume_label.setText(_translate("maximum_dvh_window", "Volume [%]"))
