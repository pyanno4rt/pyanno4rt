...
# Form implementation generated from reading ui file 'squared_overdosing_window.ui'
#
...
class Ui_squared_overdosing_window(object):
    def setupUi(self, squared_overdosing_window):
        squared_overdosing_window.setObjectName("squared_overdosing_window")
        squared_overdosing_window.setWindowModality(QtCore.Qt.ApplicationModal)
        squared_overdosing_window.resize(720, 431)
        squared_overdosing_window.setMinimumSize(QtCore.QSize(720, 431))
        squared_overdosing_window.setMaximumSize(QtCore.QSize(720, 431))
        squared_overdosing_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(squared_overdosing_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.scroll_contents.setGeometry(QtCore.QRect(0, -198, 690, 681))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.max_dose_label = QtWidgets.QLabel(self.scroll_contents)
        self.max_dose_label.setGeometry(QtCore.QRect(0, 210, 171, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.max_dose_label.setFont(font)
        self.max_dose_label.setStyleSheet("border: 0px solid;")
        self.max_dose_label.setObjectName("max_dose_label")
...
"border-color: rgb(186, 189, 182);")
        ...
        self.max_dose_ledit = QtWidgets.QLineEdit(self.scroll_contents)
        self.max_dose_ledit.setGeometry(QtCore.QRect(0, 250, 171, 30))
        self.max_dose_ledit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.max_dose_ledit.setAlignment(QtCore.Qt.AlignCenter)
        self.max_dose_ledit.setObjectName("max_dose_ledit")
...
"border-color: rgb(186, 189, 182);")
        ...
        squared_overdosing_window.setCentralWidget(self.body_widget)

        self.retranslateUi(squared_overdosing_window)
        self.embedding_cbox.setCurrentIndex(0)
        self.type_cbox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(squared_overdosing_window)

    def retranslateUi(self, squared_overdosing_window):
        _translate = QtCore.QCoreApplication.translate
        squared_overdosing_window.setWindowTitle(_translate("squared_overdosing_window", "Squared Overdosing Editor"))
        self.embedding_cbox.setItemText(0, _translate("squared_overdosing_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("squared_overdosing_window", "passive"))
        self.segment_label.setText(_translate("squared_overdosing_window", "Segment"))
        self.embedding_label.setText(_translate("squared_overdosing_window", "Embedding"))
        self.base_label.setText(_translate("squared_overdosing_window", "Base"))
        self.type_cbox.setItemText(0, _translate("squared_overdosing_window", "objective"))
        self.type_cbox.setItemText(1, _translate("squared_overdosing_window", "constraint"))
        self.type_label.setText(_translate("squared_overdosing_window", "Type"))
        self.close_component_pbutton.setText(_translate("squared_overdosing_window", "Close"))
        self.max_dose_label.setText(_translate("squared_overdosing_window", "Maximum dose [Gy]"))
        self.identifier_ledit.setPlaceholderText(_translate("squared_overdosing_window", "None"))
        self.identifier_label.setText(_translate("squared_overdosing_window", "Identifier"))
        self.link_ledit.setPlaceholderText(_translate("squared_overdosing_window", "None"))
        self.link_label.setText(_translate("squared_overdosing_window", "Link"))
        self.function_label.setText(_translate("squared_overdosing_window", "Function"))
        self.bounds_label.setText(_translate("squared_overdosing_window", "Bounds"))
        self.handling_viz_label.setText(_translate("squared_overdosing_window", "Handling & Visualization"))
        self.weight_label.setText(_translate("squared_overdosing_window", "Weight"))
        self.save_component_pbutton.setText(_translate("squared_overdosing_window", "Save"))
        self.conjunction.setText(_translate("squared_overdosing_window", "-"))
        self.optimization_label.setText(_translate("squared_overdosing_window", "Optimization"))
        self.rank_label.setText(_translate("squared_overdosing_window", "Rank"))
        self.upper_bound_ledit.setPlaceholderText(_translate("squared_overdosing_window", "None"))
        self.weight_ledit.setPlaceholderText(_translate("squared_overdosing_window", "1.0"))
        self.disp_component_check.setText(_translate("squared_overdosing_window", "Display component"))
        self.lower_bound_ledit.setPlaceholderText(_translate("squared_overdosing_window", "0.0"))
