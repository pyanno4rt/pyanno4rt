...
"border-color: rgb(186, 189, 182);")
    ...
    def retranslateUi(self, squared_underdosing_window):
        ...
        self.upper_bound_ledit.setPlaceholderText(_translate("squared_underdosing_window", "+∞"))
        ...
        self.lower_bound_ledit.setPlaceholderText(_translate("squared_underdosing_window", "-∞"))
