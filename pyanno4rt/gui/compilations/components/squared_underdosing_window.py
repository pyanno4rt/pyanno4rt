...
# Form implementation generated from reading ui file 'squared_underdosing_window.ui'
#
...
class Ui_squared_underdosing_window(object):
    def setupUi(self, squared_underdosing_window):
        squared_underdosing_window.setObjectName("squared_underdosing_window")
        squared_underdosing_window.setWindowModality(QtCore.Qt.ApplicationModal)
        squared_underdosing_window.resize(720, 431)
        squared_underdosing_window.setMinimumSize(QtCore.QSize(720, 431))
        squared_underdosing_window.setMaximumSize(QtCore.QSize(720, 431))
        squared_underdosing_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(squared_underdosing_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.scroll_contents.setGeometry(QtCore.QRect(0, -252, 690, 681))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.min_dose_label = QtWidgets.QLabel(self.scroll_contents)
        self.min_dose_label.setGeometry(QtCore.QRect(0, 210, 171, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.min_dose_label.setFont(font)
        self.min_dose_label.setStyleSheet("border: 0px solid;")
        self.min_dose_label.setObjectName("min_dose_label")
...
"border-color: rgb(186, 189, 182);")
        ...
        self.min_dose_ledit = QtWidgets.QLineEdit(self.scroll_contents)
        self.min_dose_ledit.setGeometry(QtCore.QRect(0, 250, 171, 30))
        self.min_dose_ledit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.min_dose_ledit.setAlignment(QtCore.Qt.AlignCenter)
        self.min_dose_ledit.setObjectName("min_dose_ledit")
...
"border-color: rgb(186, 189, 182);")
        ...
        squared_underdosing_window.setCentralWidget(self.body_widget)

        self.retranslateUi(squared_underdosing_window)
        self.embedding_cbox.setCurrentIndex(0)
        self.type_cbox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(squared_underdosing_window)

    def retranslateUi(self, squared_underdosing_window):
        _translate = QtCore.QCoreApplication.translate
        squared_underdosing_window.setWindowTitle(_translate("squared_underdosing_window", "Squared Underdosing Editor"))
        self.embedding_cbox.setItemText(0, _translate("squared_underdosing_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("squared_underdosing_window", "passive"))
        self.segment_label.setText(_translate("squared_underdosing_window", "Segment"))
        self.embedding_label.setText(_translate("squared_underdosing_window", "Embedding"))
        self.base_label.setText(_translate("squared_underdosing_window", "Base"))
        self.type_cbox.setItemText(0, _translate("squared_underdosing_window", "objective"))
        self.type_cbox.setItemText(1, _translate("squared_underdosing_window", "constraint"))
        self.type_label.setText(_translate("squared_underdosing_window", "Type"))
        self.close_component_pbutton.setText(_translate("squared_underdosing_window", "Close"))
        self.min_dose_label.setText(_translate("squared_underdosing_window", "Minimum dose [Gy]"))
        self.identifier_ledit.setPlaceholderText(_translate("squared_underdosing_window", "None"))
        self.identifier_label.setText(_translate("squared_underdosing_window", "Identifier"))
        self.link_ledit.setPlaceholderText(_translate("squared_underdosing_window", "None"))
        self.link_label.setText(_translate("squared_underdosing_window", "Link"))
        self.function_label.setText(_translate("squared_underdosing_window", "Function"))
        self.bounds_label.setText(_translate("squared_underdosing_window", "Bounds"))
        self.handling_viz_label.setText(_translate("squared_underdosing_window", "Handling & Visualization"))
        self.weight_label.setText(_translate("squared_underdosing_window", "Weight"))
        self.save_component_pbutton.setText(_translate("squared_underdosing_window", "Save"))
        self.conjunction.setText(_translate("squared_underdosing_window", "-"))
        self.optimization_label.setText(_translate("squared_underdosing_window", "Optimization"))
        self.rank_label.setText(_translate("squared_underdosing_window", "Rank"))
        self.upper_bound_ledit.setPlaceholderText(_translate("squared_underdosing_window", "None"))
        self.weight_ledit.setPlaceholderText(_translate("squared_underdosing_window", "1.0"))
        self.disp_component_check.setText(_translate("squared_underdosing_window", "Display component"))
        self.lower_bound_ledit.setPlaceholderText(_translate("squared_underdosing_window", "0.0"))
