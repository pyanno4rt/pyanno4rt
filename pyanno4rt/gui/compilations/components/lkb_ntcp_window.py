...
# Form implementation generated from reading ui file 'lkb_ntcp_window.ui'
#
...
class Ui_lkb_ntcp_window(object):
    def setupUi(self, lkb_ntcp_window):
        lkb_ntcp_window.setObjectName("lkb_ntcp_window")
        lkb_ntcp_window.setWindowModality(QtCore.Qt.ApplicationModal)
        lkb_ntcp_window.resize(720, 431)
        lkb_ntcp_window.setMinimumSize(QtCore.QSize(720, 431))
        lkb_ntcp_window.setMaximumSize(QtCore.QSize(720, 431))
        lkb_ntcp_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(lkb_ntcp_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.scroll_contents.setGeometry(QtCore.QRect(0, -331, 690, 760))
...
"border-color: rgb(186, 189, 182);")
        ...
        self.slope_label = QtWidgets.QLabel(self.scroll_contents)
        self.slope_label.setGeometry(QtCore.QRect(170, 210, 151, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.slope_label.setFont(font)
        self.slope_label.setStyleSheet("border: 0px solid;")
...
"border-color: rgb(186, 189, 182);")
        ...
        self.td50_label = QtWidgets.QLabel(self.scroll_contents)
        self.td50_label.setGeometry(QtCore.QRect(0, 210, 151, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.td50_label.setFont(font)
        self.td50_label.setStyleSheet("border: 0px solid;")
        self.td50_label.setObjectName("td50_label")
        self.slope_ledit = QtWidgets.QLineEdit(self.scroll_contents)
        self.slope_ledit.setGeometry(QtCore.QRect(170, 250, 151, 31))
        self.slope_ledit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.slope_ledit.setAlignment(QtCore.Qt.AlignCenter)
        self.slope_ledit.setObjectName("slope_ledit")
        self.td50_ledit = QtWidgets.QLineEdit(self.scroll_contents)
        self.td50_ledit.setGeometry(QtCore.QRect(0, 250, 151, 31))
        self.td50_ledit.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(238, 238, 236);\n"
"border: 1px solid;\n"
"border-color: rgb(186, 189, 182);")
        self.td50_ledit.setAlignment(QtCore.Qt.AlignCenter)
        self.td50_ledit.setObjectName("td50_ledit")
        ...
        lkb_ntcp_window.setCentralWidget(self.body_widget)

        self.retranslateUi(lkb_ntcp_window)
        self.embedding_cbox.setCurrentIndex(0)
        self.type_cbox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(lkb_ntcp_window)

    def retranslateUi(self, lkb_ntcp_window):
        _translate = QtCore.QCoreApplication.translate
        lkb_ntcp_window.setWindowTitle(_translate("lkb_ntcp_window", "Lyman-Kutcher-Burman NTCP Editor"))
        self.embedding_cbox.setItemText(0, _translate("lkb_ntcp_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("lkb_ntcp_window", "passive"))
        self.segment_label.setText(_translate("lkb_ntcp_window", "Segment"))
        self.embedding_label.setText(_translate("lkb_ntcp_window", "Embedding"))
        self.base_label.setText(_translate("lkb_ntcp_window", "Base"))
        self.type_cbox.setItemText(0, _translate("lkb_ntcp_window", "objective"))
        self.type_cbox.setItemText(1, _translate("lkb_ntcp_window", "constraint"))
        self.type_label.setText(_translate("lkb_ntcp_window", "Type"))
        self.close_component_pbutton.setText(_translate("lkb_ntcp_window", "Close"))
        self.identifier_ledit.setPlaceholderText(_translate("lkb_ntcp_window", "None"))
        self.identifier_label.setText(_translate("lkb_ntcp_window", "Identifier"))
        self.link_ledit.setPlaceholderText(_translate("lkb_ntcp_window", "None"))
        self.link_label.setText(_translate("lkb_ntcp_window", "Link"))
        self.function_label.setText(_translate("lkb_ntcp_window", "Function"))
        self.bounds_label.setText(_translate("lkb_ntcp_window", "Bounds"))
        self.handling_viz_label.setText(_translate("lkb_ntcp_window", "Handling & Visualization"))
        self.weight_label.setText(_translate("lkb_ntcp_window", "Weight"))
        self.save_component_pbutton.setText(_translate("lkb_ntcp_window", "Save"))
        self.conjunction.setText(_translate("lkb_ntcp_window", "-"))
        self.optimization_label.setText(_translate("lkb_ntcp_window", "Optimization"))
        self.rank_label.setText(_translate("lkb_ntcp_window", "Rank"))
        self.upper_bound_ledit.setPlaceholderText(_translate("lkb_ntcp_window", "1.0"))
        self.weight_ledit.setPlaceholderText(_translate("lkb_ntcp_window", "1.0"))
        self.disp_component_check.setText(_translate("lkb_ntcp_window", "Display component"))
        self.lower_bound_ledit.setPlaceholderText(_translate("lkb_ntcp_window", "0.0"))
