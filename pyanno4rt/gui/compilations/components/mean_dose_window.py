...
# Form implementation generated from reading ui file 'mean_dose_window.ui'
#
...
class Ui_mean_dose_window(object):
    def setupUi(self, mean_dose_window):
        mean_dose_window.setObjectName("mean_dose_window")
        mean_dose_window.setWindowModality(QtCore.Qt.ApplicationModal)
        mean_dose_window.resize(720, 431)
        mean_dose_window.setMinimumSize(QtCore.QSize(720, 431))
        mean_dose_window.setMaximumSize(QtCore.QSize(720, 431))
        mean_dose_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(mean_dose_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.target_dose_ledit.setGeometry(QtCore.QRect(0, 250, 171, 31))
...
"border-color: rgb(186, 189, 182);")
        ...
        mean_dose_window.setCentralWidget(self.body_widget)

        self.retranslateUi(mean_dose_window)
        self.embedding_cbox.setCurrentIndex(0)
        self.type_cbox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(mean_dose_window)

    def retranslateUi(self, mean_dose_window):
        _translate = QtCore.QCoreApplication.translate
        mean_dose_window.setWindowTitle(_translate("mean_dose_window", "Mean Dose Editor"))
        self.embedding_cbox.setItemText(0, _translate("mean_dose_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("mean_dose_window", "passive"))
        self.segment_label.setText(_translate("mean_dose_window", "Segment"))
        self.embedding_label.setText(_translate("mean_dose_window", "Embedding"))
        self.base_label.setText(_translate("mean_dose_window", "Base"))
        self.type_cbox.setItemText(0, _translate("mean_dose_window", "objective"))
        self.type_cbox.setItemText(1, _translate("mean_dose_window", "constraint"))
        self.type_label.setText(_translate("mean_dose_window", "Type"))
        self.close_component_pbutton.setText(_translate("mean_dose_window", "Close"))
        self.target_dose_label.setText(_translate("mean_dose_window", "Target dose [Gy]"))
        self.identifier_ledit.setPlaceholderText(_translate("mean_dose_window", "None"))
        self.identifier_label.setText(_translate("mean_dose_window", "Identifier"))
        self.link_ledit.setPlaceholderText(_translate("mean_dose_window", "None"))
        self.link_label.setText(_translate("mean_dose_window", "Link"))
        self.function_label.setText(_translate("mean_dose_window", "Function"))
        self.bounds_label.setText(_translate("mean_dose_window", "Bounds"))
        self.handling_viz_label.setText(_translate("mean_dose_window", "Handling & Visualization"))
        self.weight_label.setText(_translate("mean_dose_window", "Weight"))
        self.save_component_pbutton.setText(_translate("mean_dose_window", "Save"))
        self.conjunction.setText(_translate("mean_dose_window", "-"))
        self.optimization_label.setText(_translate("mean_dose_window", "Optimization"))
        self.rank_label.setText(_translate("mean_dose_window", "Rank"))
        self.upper_bound_ledit.setPlaceholderText(_translate("mean_dose_window", "None"))
