...
# Form implementation generated from reading ui file 'squared_deviation_window.ui'
#
...
class Ui_squared_deviation_window(object):
    def setupUi(self, squared_deviation_window):
        squared_deviation_window.setObjectName("squared_deviation_window")
        squared_deviation_window.setWindowModality(QtCore.Qt.ApplicationModal)
        squared_deviation_window.resize(720, 431)
        squared_deviation_window.setMinimumSize(QtCore.QSize(720, 431))
        squared_deviation_window.setMaximumSize(QtCore.QSize(720, 431))
        squared_deviation_window.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(211, 215, 207);")
        self.body_widget = QtWidgets.QWidget(squared_deviation_window)
...
"border-color: rgb(186, 189, 182);")
        ...
        self.target_dose_ledit.setGeometry(QtCore.QRect(0, 250, 171, 30))
...
"border-color: rgb(186, 189, 182);")
    ...
    def retranslateUi(self, squared_deviation_window):
        ...
        squared_deviation_window.setWindowTitle(_translate("squared_deviation_window", "Squared Deviation Editor"))
        self.embedding_cbox.setItemText(0, _translate("squared_deviation_window", "active"))
        self.embedding_cbox.setItemText(1, _translate("squared_deviation_window", "passive"))
        self.segment_label.setText(_translate("squared_deviation_window", "Segment"))
        self.embedding_label.setText(_translate("squared_deviation_window", "Embedding"))
        self.base_label.setText(_translate("squared_deviation_window", "Base"))
        ...
        self.upper_bound_ledit.setPlaceholderText(_translate("squared_deviation_window", "+∞"))
        ...
        self.lower_bound_ledit.setPlaceholderText(_translate("squared_deviation_window", "-∞"))
