...
"border-color: rgb(186, 189, 182);")
    ...
    def retranslateUi(self, equivalent_uniform_dose_window):
        ...
        self.upper_bound_ledit.setPlaceholderText(_translate("equivalent_uniform_dose_window", "+∞"))
        ...
        self.lower_bound_ledit.setPlaceholderText(_translate("equivalent_uniform_dose_window", "-∞"))
