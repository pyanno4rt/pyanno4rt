...
from pyanno4rt.input_check.check_maps import (
    configuration_map, evaluation_map, model_display_map, model_map,
    objective_map, optimization_map, top_level_map, tune_space_map)
...
class InputChecker():
    ...
    def __init__(self):
        ...
        check_maps = (configuration_map, evaluation_map, model_map,
                      model_display_map, objective_map, optimization_map,
    ...
    def approve(
        ...
        for key, value in input_dictionary.items():
            ...
            if key in self.check_map:
                ...
                warn("The key '{key}' cannot be found in the check map and is "
