...
class NeuralNetworkTCP(MachineLearningComponentClass):
    """
    Neural network TCP component class.

    This class provides methods to compute the value and the gradient of the \
    neural network TCP component, as well as to add the neural network model.
