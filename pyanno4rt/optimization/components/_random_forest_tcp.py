...
class RandomForestTCP(MachineLearningComponent):
    """
    Random forest TCP component class.

    This class provides methods to compute the value and the gradient of the \
    random forest TCP component, as well as to add the random forest model.
    ...
    def to_dict(self):
        ...
        return {'Random Forest TCP': dictionary}
