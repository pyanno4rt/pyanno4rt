"""K-nearest neighbors NTCP component."""
...
class KNeighborsNTCP(MachineLearningComponent):
    ...
    model : object of class \
        :class:`~pyanno4rt.learning_model.frequentist._k_nearest_neighbors.KNeighborsModel`
    ...
    def to_dict(self):
        ...
        return {'K-Nearest Neighbors NTCP': dictionary}
