"""Soft decision tree outcome component."""
...
from pyanno4rt.learning.models import SoftDecisionTree
...
class SoftDecisionTreeOutcome(MachineLearningComponent):
    """
    Soft decision tree outcome component class.

    This class provides methods to handle a soft decision tree outcome \
    ...
    model : object of class \
        :class:`~pyanno4rt.learning.models.tree._soft_decision_tree.SoftDecisionTree`
        The object used to represent the soft decision tree outcome model.
    ...
    def __init__(
        ...
        super().__init__(
            name='Soft Decision Tree Outcome',
            segment=segment,
    ...
    def from_dict(
        ...
        -------
        object of class \
            :class:`~pyanno4rt.optimization.components._soft_decision_tree_outcome.SoftDecisionTreeOutcome`
            The object used to represent the naive Bayes outcome component.
        """

        # Deserialize the model
        dictionary['model'] = SoftDecisionTree.from_dict(dictionary['model'])
