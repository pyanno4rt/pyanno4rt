...
class DecisionTreeTCP(MachineLearningComponent):
    """
    Decision tree TCP component class.

    This class provides methods to compute the value and the gradient of the \
    decision tree TCP component, as well as to add the decision tree model.
    ...
    def to_dict(self):
        ...
        return {'Decision Tree TCP': dictionary}
