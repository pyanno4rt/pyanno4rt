...
class RandomForestNTCP(MachineLearningComponent):
    ...
    random forest NTCP component, as well as to add the random forest model.
    ...
    model : object of class \
        :class:`~pyanno4rt.learning_model.frequentist._random_forest.RandomForestModel`
    ...
    def to_dict(self):
        ...
        return {'Random Forest NTCP': dictionary}
