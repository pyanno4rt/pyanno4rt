...
from pyanno4rt.learning.models import RandomForest
...
class RandomForestOutcome(MachineLearningComponent):
    ...
    This class provides methods to handle a random forest outcome model-based \
    component.
    ...
    model : object of class \
        ...
        The object used to represent the random forest outcome model.
    ...
    def from_dict(
        ...
        object of class \
            ...
            The object used to represent the random forest outcome component.
        """

        # Deserialize the model
        dictionary['model'] = RandomForest.from_dict(dictionary['model'])
