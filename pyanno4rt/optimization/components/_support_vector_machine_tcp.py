"""Support vector machine TCP component."""
...
from pyanno4rt.learning_model.frequentist.addons import (
    ...
    sigmoid_decision_function, linear_decision_gradient, poly_decision_gradient,
    rbf_decision_gradient, sigmoid_decision_gradient)
...
class SupportVectorMachineTCP(MachineLearningComponentClass):
    """
    Support vector machine TCP component class.

    This class provides methods to compute the value and the gradient of the \
    support vector machine TCP component, as well as to add the support \
