...
class NeuralNetworkNTCP(ModelObjectiveClass):
    """
    Neural network NTCP objective class.

    This class provides methods to compute the value and the gradient of the \
    neural network NTCP objective, as well as to add the neural network model \
