...
class DecisionTreeNTCP(ModelObjectiveClass):
    ...
    decision tree NTCP objective, as well as to add the decision tree model \
    ...
    model_parameters : dict
        ...
        - ``feature_filter`` : tuple, default = ((), 'remove'), (sub)set \
            ...
            prior to fitting the decision tree model;
        ...
        - ``preprocessing_steps`` : tuple, default = ('Equalizer',), sequence \
            ...
            the preprocessing pipeline for the decision tree model;
        ...
        - ``inspect_model`` : bool, default = False, indicator for the \
            inspection of the decision tree model;
        ...
        - ``oof_splits`` : int, default = 5, number of splits for the \
            ...
            step of the decision tree model;
    ...
    model : object of class `DecisionTreeModel`
        Instance of the class `DecisionTreeModel`, which holds methods to \
        preprocess, tune, train, inspect and evaluate the decision tree model.
    ...
    def add_model(self):
        """Add the decision tree model to the objective."""
        # Initialize the datahub
        hub = Datahub()

        # Log a message about the model addition
        hub.logger.display_info("Adding decision tree model for '{}' ..."
                                .format(self.name))
