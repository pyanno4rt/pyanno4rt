"""Logistic regression NTCP objective."""
...
class LogisticRegressionNTCP(MachineLearningObjectiveClass):
    """
    Logistic regression NTCP objective class.

    This class provides methods to compute the value and the gradient of the \
    logistic regression NTCP objective, as well as to add the logistic \
