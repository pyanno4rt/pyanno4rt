...
class RandomForestNTCP(ModelObjectiveClass):
    ...
    random forest NTCP objective, as well as to add the random forest model \
    ...
    model_parameters : dict
        ...
        - ``feature_filter`` : tuple, default = ((), 'remove'), (sub)set \
            ...
            prior to fitting the random forest model;
        ...
        - ``preprocessing_steps`` : tuple, default = ('Equalizer',), sequence \
            ...
            the preprocessing pipeline for the random forest model;
        ...
        - ``inspect_model`` : bool, default = False, indicator for the \
            inspection of the random forest model;
        ...
        - ``oof_splits`` : int, default = 5, number of splits for the \
            ...
            step of the random forest model;
    ...
    model : object of class `RandomForestModel`
        Instance of the class `RandomForestModel`, which holds methods to \
        preprocess, tune, train, inspect and evaluate the random forest model.
    ...
    def __init__(
        ...
        super().__init__(name='Random Forest NTCP',
                         parameter_name=(),
                         parameter_category=(),
    ...
    def add_model(self):
        """Add the random forest model to the objective."""
        # Initialize the datahub
        hub = Datahub()

        # Log a message about the model addition
        hub.logger.display_info("Adding random forest model for '{}' ..."
                                .format(self.name))
